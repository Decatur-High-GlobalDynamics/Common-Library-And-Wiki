...
public class TeleopSwerveCommand extends CommandBase
{
        ...
        private double getSpeed()
        {
                if (slowSpeedSupplier.getAsBoolean())
                        return SwerveConstants.Swerve.SLOW_SPEED;
                if (fastSpeedSupplier.getAsBoolean())
                        return SwerveConstants.Swerve.FAST_SPEED;
                return SwerveConstants.Swerve.NORMAL_SPEED;
        }
        ...
        public void execute()
        {
                ...
                s_Swerve.drive(new Translation2d(translationVal, strafeVal)
                                .times(speed * SwerveConstants.Swerve.BASE_DRIVE_SPEED),
                                rotationVal * speed * SwerveConstants.Swerve.BASE_TURN_SPEED,
